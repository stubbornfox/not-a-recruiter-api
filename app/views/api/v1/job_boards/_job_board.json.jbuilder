json.(job_board, :id, :title, :seo_title, :seo_description, :url, :custom_domain_url, :intro, :header_setup, :banner_setup, :og_image_setup, :banner_video_url, :banner_image, :organization_id)
